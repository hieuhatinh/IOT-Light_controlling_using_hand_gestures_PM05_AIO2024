...
def label_dict_from_config_file(relative_path):
    """
    Read file hand_gesture.yaml 
    Return: Dictionary contain gesture labels
    """
...
if __name__ == "__main__":
    LABEL_TAG = label_dict_from_config_file("src/hand_gesture.yaml")
    data_path = 'src/data_collection/data2'
    sign_img_path = 'src/data_collection/sign_imgs2'
